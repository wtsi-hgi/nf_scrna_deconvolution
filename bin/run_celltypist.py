...
# command with example inputs arguments: python3 run_celltypist.py --samplename ukbb_scrna9479582 --filtered_h5ad ./prepped_cellranger_filtered.h5ad
...
def run_celltypist(vireo_donor_ids_tsv, filtered_matrix_h5, samplename,
    ...
    """run Celltypist on prepped cellranger h5 file"""
